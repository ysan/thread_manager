#ifndef _MODULE_A_EXTERN_H_
#define _MODULE_A_EXTERN_H_
...
class module_a_extern : public threadmgr::CThreadMgrExternalIf
{
public:
	...
	explicit module_a_extern (CThreadMgrExternalIf *p_if)
		: CThreadMgrExternalIf (p_if)
		, m_module_id(static_cast<int>(module::module_a))
	{
	}

	virtual ~module_a_extern (void) {
	};
